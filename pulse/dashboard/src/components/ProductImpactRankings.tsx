...
const PRODUCT_TYPE_MAP: Record<string, Record<string, string>> = {
  ...
  lhc_fcn: {
    Consumer:      'Eco-Conscious Fabric Softener',
  ...
  lhc_fca: {
    Consumer:      'Fragrance-Boosted Fabric Care',
    Customer:      'Club-Format Fabric Enhancers',
    Technology:    'Micro-Encapsulated Scent Beads',
    Government:    'Allergen-Labeled Scent Products',
    Environmental: 'Plant-Based Fabric Softener',
    Competitive:   'Specialty Fabric Protection Sprays',
  },
  lhc_ffi: {
  ...
  lhc_lad: {
    Consumer:      'Liquid Laundry Detergent (Sensitive)',
    Customer:      'Online-Optimized Detergent Formats',
    Technology:    'AI-Dosed Smart Dispensing',
    Government:    'EU Detergent Regulation (Labeling)',
    Environmental: 'Sheet / Strip Laundry Detergent',
    Competitive:   'Persil-Tier Premium Liquid',
  },
  lhc_hdw: {
    Consumer:      'Rinse-Aid & Specialty Dishwasher',
    Customer:      'Private-Label Dishwasher Tabs',
    Technology:    'Water-Saving Dishwasher Formulas',
  ...
  lhc_hsc: {
    Consumer:      'Artisanal / Premium Soap Bars',
    Customer:      'Hygiene-Bundled Hand Soap Sets',
    Technology:    'Foam-Tech Hand Sanitizer Combos',
    Government:    'Biocide-Compliant Hand Hygiene',
    Environmental: 'Package-Free Bar Soap',
    Competitive:   'Luxury Hand Soap (Fragrance-Led)',
  },
  lhc_ic: {
