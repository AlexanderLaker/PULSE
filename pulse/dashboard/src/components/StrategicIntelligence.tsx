...
const HENKEL_CONTEXT: Record<string, { position: string; brands: string; keyCompetitors: string; henkelEdge: string }> = {
  ...
  hair_care:    { position: 'Top-5 player, strong in DE/EU', brands: 'Schwarzkopf, Gliss, Schauma, Nature Box', keyCompetitors: "P&G (Pantene, Head&Shoulders), L'Oréal (Elvital), Unilever (Dove)", henkelEdge: 'Bond-repair technology (Gliss), sustainable formulation, European distribution density' },
  hair_styling: { position: 'Strong niche player', brands: 'got2b, Taft, Schwarzkopf', keyCompetitors: "L'Oréal, Church & Dwight (Batiste), Unilever (TRESemmé)", henkelEdge: 'Youth appeal (got2b), European heritage styling (Taft), texture innovation' },
  hair_body:    { position: 'Selective player', brands: 'Fa, Dial, Right Guard', keyCompetitors: 'Unilever (Dove, Axe), P&G (Old Spice, Olay), Beiersdorf (Nivea)', henkelEdge: 'Value positioning, fragrance heritage (Fa)' },
  lhc_fcn:      { position: 'European leader, regional strength', brands: 'Persil, Le Chat, Dixan', keyCompetitors: 'P&G (Ariel, Tide), Unilever (Omo, Surf), Private Label', henkelEdge: 'Persil brand equity in DACH, deep enzyme and surfactant science, sustainability credibility' },
  lhc_fca:      { position: 'Solid mid-tier', brands: 'Vernel, Silan, Snuggle', keyCompetitors: 'P&G (Lenor/Downy), Unilever (Comfort), Private Label', henkelEdge: 'Fragrance technology, European market access' },
  lhc_ffi:      { position: 'Niche competitor', brands: 'Bref, WC Frisch', keyCompetitors: 'Reckitt (Harpic), S.C. Johnson (Mr Muscle), Private Label', henkelEdge: 'Toilet care innovation (Bref Power Activ), strong DACH base' },
  lhc_lad:      { position: 'Strong European position', brands: 'Persil, All, Dixan', keyCompetitors: 'P&G (Ariel, Tide), Unilever (Surf), Private Label', henkelEdge: 'Concentrated/dosing innovation, sustainability narrative (Persil Green Power)' },
  lhc_hdw:      { position: 'Regional challenger', brands: 'Somat, Pril', keyCompetitors: 'Reckitt (Finish), P&G (Cascade), Private Label', henkelEdge: 'German engineering perception, all-in-one tablet innovation (Somat Excellence)' },
  lhc_adw:      { position: 'Established EMEA player', brands: 'Pril, Somat', keyCompetitors: 'P&G (Dawn/Fairy), Colgate-Palmolive (Palmolive), Private Label', henkelEdge: 'Manual + auto combined brand architecture, eco-positioning' },
  lhc_hsc:      { position: 'Competitive but commoditized', brands: 'Bref, Sidol, Pur', keyCompetitors: 'Reckitt (Cillit Bang, Dettol), S.C. Johnson, Private Label', henkelEdge: 'Multi-surface innovation, Bref Pro Nature line' },
  lhc_ic:       { position: 'Small, niche', brands: 'Pattex (adjacent), specialty', keyCompetitors: 'S.C. Johnson (Raid, Baygon), Reckitt (Mortein), Private Label', henkelEdge: 'Limited — low strategic fit relative to core portfolio' },
};
