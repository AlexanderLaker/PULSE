 ...
 * ├─ 27 additions derived from the 82-trend v3.1 set (v3.5 recalibration retained same innovation topology)
...
'PRISM Trend Database: C-13, G-04, T-05',
 ...
 // ============================================================
 // ADDITIONS (– inn_43)
 // Derived from the 99-trend v3.5 set. Bain-grade convergence
...
'PRISM Trend Database: C-31, T-18, X-10, X-13',
 ...
 id:'inn_51',
 number: 51,
 name:'Smart IoT Indoor Insect Defense Hub',
 subtitle:'A connected indoor mosquito & pest defense hub — UV/CO2-lure trap plus smartphone monitoring and subscription refill cartridges — extending IC from seasonal spray to always-on household platform.',
 category:'LHC: IC (Insect Control)',
 categoryShort:'IC',
 categoryGroup:'LHC',
 type:'TRANSFORMATIONAL',
 ...
 fitScore: 80,
 horizon:'2028–2030',
 consumerNeed:'Indoor insect defense is structurally under-served: consumers rely on episodic sprays and plug-ins but 73% report "silent failure" — mosquitoes or moths appear despite protection. Climate change is pushing previously-seasonal species into year-round indoor presence in Southern Europe and the US Sunbelt. The bathroom/laundry IoT trend (T-18) is now extending into household hygiene hardware, and no mainstream IC brand has a connected platform — the space is owned by premium DTC insurgents (Katchy, Thermacell E-Series). A connected hub + subscription cartridge model locks in the household for 5+ years and captures the always-on defense opportunity vs. inn_11\'s seasonal outdoor focus.',
 techSpecs: [
 { title:'UV + CO2 Lure Technology', description:'Silent, chemical-free UV-A lure combined with slow-release CO2 mimic (non-toxic) to attract mosquitoes, moths, fruit flies, and gnats. Proven 4x catch-rate vs. UV-only traps in EPA-style lab trials.', icon:'bolt' },
 { title:'Connected Monitoring', description:'WiFi/BLE hub reports catch count, species (AI image classifier on-device), and seasonal pressure forecast to smartphone app. Push alerts when cartridge needs swap or when regional mosquito index spikes.', icon:'sensors' },
 { title:'Subscription Refill Cartridges', description:'Dual-chamber cartridge (lure + adhesive catch pad) with 45-day lifetime. Auto-reorder via DTC or household AI agent (T-11 integration). Fully recyclable; cartridge body is mono-material PP for EU PPWR alignment.', icon:'cached' },
 { title:'Family-Safe by Design', description:'No DEET, no pyrethroids, no repellent fog. Child- and pet-safe placement. MoCRA/BPR-compliant. Silent operation (<30 dB) for bedroom deployment.', icon:'shield' },
 ],
 portfolioFit:'A structural extension of the insect-control portfolio from chemical episodic (inn_11) to connected always-on platform. €45–70M investment: hardware tooling, app, firmware. Targets Southern European homes, US Sunbelt, tropical/subtropical Asia. Revenue target €120–180M by 2032. Hardware sold at near-cost; 65%+ GM from cartridge subscription. Complements inn_11 (outdoor climate-adaptive spray) — together they form the first fully-integrated indoor/outdoor insect defense offer in mainstream FMCG.',
 evaluation: [
 { label:'Market Potential', score: 82, rating:'STRONG' },
 { label:'Consumer Sentiment', score: 84, rating:'STRONG' },
 { label:'Strategic Fit', score: 80, rating:'HIGH' },
 ...
 trendConnections: [
 { code:'E-05', name:'Climate-Driven Insect Range Expansion', direction: 'Expansion', rationale:'Core demand driver — year-round indoor pressure' },
 { code:'T-18', name:'Bathroom & Laundry-Room IoT', direction: 'Expansion', rationale:'v3.3 — enabling infrastructure for connected household devices' },
 { code:'T-11', name:'AI Shopping Agents', direction: 'Expansion', rationale:'Agent-mediated cartridge reorder channel' },
 { code:'K-06', name:'Subscription / Lock-in Models', direction: 'Expansion', rationale:'Cartridge-subscription revenue model' },
 { code:'G-10', name:'EU Biocidal Products Regulation', direction: 'Contraction', rationale:'Chemical-free lure pre-complies with BPR 2026 restrictions' },
 { code:'C-23', name:'Wellness-Beauty Convergence', direction: 'Expansion', rationale:'Family-safe, silent operation reads as wellness, not pesticide' },
 { code:'X-10', name:'Amazon Private Label', direction: 'Contraction', rationale:'Hardware lock-in defends against PL encroachment' },
 ],
 sources: [
'WHO World Malaria Report 2025 — vector range expansion data',
'Mintel Household Pest Control Report 2026',
'Katchy / Thermacell DTC category analysis',
'EPA Indoor Mosquito Trap Efficacy Studies (2024)',
'PRISM Trend Database: E-05, T-18, G-10',
 ],
 consumerJourneyStages: ['3 — Prepare','4 — Add Products','7 — Maintain & Optimize'],
 imageGradient:'linear-gradient(135deg, #065f46 0%, #14532d 100%)',
 imageAccent:'#10b981',
 },
 {
 id:'inn_52',
 number: 52,
 name:'Probiotic Toilet & Drain Care System',
 subtitle:'A microbiome-science toilet & drain care range that maintains a healthy bathroom biome — pre/probiotic formulation protects septic and municipal infrastructure while delivering visible cleanliness.',
 category:'LHC: Toilet Care',
 categoryShort:'Toilet',
 categoryGroup:'LHC',
 type:'WHITE_SPOT',
 ...
 { title:'Full-System Range', description:'Bowl cleaner gel, rim block, automatic cistern tablet, and drain gel. Shared active platform; shared scent architecture (low-musk herbal with subtle freshness). Septic-safe & greywater-safe certified.', icon:'layers' },
 { title:'Bleach-Free, Quat-Free', description:'No sodium hypochlorite, no quaternary ammonium, no strong acids. Safer-on-skin & respiratory-safe positioning. EU Green Claims Directive-substantiable via university biome studies.', icon:'verified' },
 ],
 portfolioFit:'Transforms HSC toilet care from commodity bleach-gel positioning to premium biome-science brand — analogous to what microbiome science did for scalp (inn_01) and skin in the 2020s. €35–55M investment: fermentation sourcing, bowl-cleaner stability R&D, branding. Revenue target €180–260M by 2032 with 48%+ GM. Deploys under a trusted toilet-care master brand in an "Active Biome" line, priced at 55–80% premium vs. the category leader. Complements inn_38 (biodiversity-positive) — inn_52 is the health/biome angle, inn_38 is the ecosystem/footprint angle; together they give the portfolio a full answer to both regulatory and consumer pressure on toilet chemistry.',
 evaluation: [
 { label:'Market Potential', score: 80, rating:'HIGH' },
 { label:'Consumer Sentiment', score: 83, rating:'STRONG' },
 { label:'Strategic Fit', score: 85, rating:'OPTIMAL' },
 ],
 regionalReadiness: [
      { region:'Europe', readiness: 'OPTIMAL' },
      { region:'North America', readiness: 'HIGH' },
 ...
 trendConnections: [
 { code:'T-04', name:'Microbiome Science for Hair and Skin', direction: 'Expansion', rationale:'Core technology platform — extends microbiome science into toilet/drain' },
 { code:'C-19', name:'Skinification of Home Care', direction: 'Expansion', rationale:'Bathroom-biome-as-skin logic anchors positioning' },
 { code:'G-05', name:'EU Green Claims Directive', direction: 'Contraction', rationale:'Biome-shift claims substantiable via academic partnerships' },
 { code:'G-06', name:'Bleach & Quat Regulatory Pressure', direction: 'Contraction', rationale:'Pre-compliant formulation as moat' },
 { code:'T-02', name:'Bio-Based and Green Chemistry Alternatives', direction: 'Expansion', rationale:'Pre/probiotic actives are the post-bleach chemistry shift' },
 { code:'C-03', name:'Premiumization Acceleration', direction: 'Expansion', rationale:'Super-premium toilet care category creation' },
 { code:'G-04', name:'EU PPWR', direction: 'Contraction', rationale:'Concentrated refill formats reduce packaging by 60%' },
 ],
 sources: [
'Mintel Toilet Care Market Report 2025',
'Johns Hopkins Bathroom Microbiome Studies (2023–2025)',
'Novozymes / IFF Probiotic Home-Care White Papers',
'EU ECHA Biocide & Detergent Ingredient Watchlist 2026',
'PRISM Trend Database: T-04, C-19, G-05, G-06',
 ],
 consumerJourneyStages: ['4 — Add Products','7 — Maintain & Optimize'],
 imageGradient:'linear-gradient(135deg, #0e7490 0%, #134e4a 100%)',
 imageAccent:'#06b6d4',
 },
 {
 id:'inn_53',
 number: 53,
 name:'Scent-Layering Wardrobe Fragrance System',
 subtitle:'A modular scent-layering system for fabric softeners and wardrobe aroma — premium, mix-your-own signature scents across softener, in-wash booster, and wardrobe diffuser for a coherent personal fragrance signature.',
 category:'LHC: FFI (Fabric Finishing)',
 categoryShort:'FFI',
 categoryGroup:'LHC',
 type:'PREMIUMIZATION',
 typeLabel:'Premiumization',
 ...
 fitScore: 87,
 horizon:'2027–2028',
 consumerNeed:'Fabric finishing (FFI — softeners, boosters, conditioners) is commoditizing under private-label and sheet/capsule disruption, but fine-fragrance premiumisation in home care is the dominant premium-price driver (C-09). Consumers increasingly treat laundry scent as a personal-style signature — yet today\'s market forces a single-scent decision per bottle. No mainstream FFI brand offers scent layering. A modular system — base softener + accord boosters (musk, floral, fresh, woody, gourmand) + matching wardrobe diffuser — lets a consumer build a signature across their laundry and closet. This creates a structural premium moat distinct from inn_33\'s bio-fragrance single-scent premium, and defends FFI GM against private-label compression.',
 techSpecs: [
 { title:'Modular Accord Boosters', description:'Five fine-fragrance accord booster shots (Musk, Floral, Fresh Linen, Woody, Gourmand Vanilla) formulated in partnership with a major fragrance house. Layer in-wash with any base softener at 2–8 ml; the accord binds to fibre via an encapsulation polymer for extended fragrance release up to 14 days.', icon:'palette' },
 { title:'Smart Mixing App', description:'App-based scent-profiling quiz generates a suggested layering recipe per household member (partner/teen/kids). Scan the wardrobe barcode to save signature per outfit cluster (work, weekend, activewear, formal).', icon:'tune' },
 { title:'Matching Wardrobe Diffuser', description:'Plug-free silicone-bead wardrobe diffuser uses the same accord oils as the in-wash boosters — single fragrance identity across in-wash + closet. Refill subscription via DTC.', icon:'air' },
 { title:'REACH-Proactive Fragrance', description:'All accord boosters formulated without materials on the 2026 REACH musk/lilial watchlist. Precision-fermentation-derived notes (T-15) where possible. EU Green Claims compliant.', icon:'verified' },
 ],
 portfolioFit:'Premiumizes the FFI portfolio into a fine-fragrance system play. €30–45M investment: fragrance-house partnership, capsule encapsulation scale-up, app development, diffuser hardware. Deploys under a premium softener master brand with fragrance equity. Revenue target €140–210M by 2031 with 58%+ GM on booster shots and 70%+ GM on diffuser refills. Complements inn_33 (pure bio-fragrance premium softener) — together they cover the full premium FFI opportunity: single-scent mastery (inn_33) and modular scent-signature (inn_53). Channel: mass retail, online DTC, selective beauty retail (Sephora crossover tested in EU).',
 evaluation: [
 { label:'Market Potential', score: 81, rating:'HIGH' },
 { label:'Consumer Sentiment', score: 86, rating:'OPTIMAL' },
 { label:'Strategic Fit', score: 87, rating:'OPTIMAL' },
 ],
 regionalReadiness: [
      { region:'Europe', readiness: 'OPTIMAL' },
      { region:'North America', readiness: 'OPTIMAL' },
 ...
 trendConnections: [
 { code:'C-09', name:'Fragrance & Sensory Premiumization in Home Care', direction: 'Expansion', rationale:'Core trend — scent layering is the next premium lever' },
 { code:'C-03', name:'Premiumization Acceleration', direction: 'Expansion', rationale:'Modular system supports 120–180 price-index vs. mass softener' },
 { code:'C-17', name:'Personalization at Scale', direction: 'Expansion', rationale:'App-based per-member signature personalisation' },
 { code:'T-15', name:'Precision Fermentation Fragrance', direction: 'Expansion', rationale:'Fermentation-derived musk/woody notes bypass REACH risk' },
 { code:'G-08', name:'REACH Musk & Lilial Restrictions', direction: 'Contraction', rationale:'Pre-compliant accord library as regulatory moat' },
 { code:'X-09', name:'Private-Label Compression in FFI', direction: 'Contraction', rationale:'System/subscription defends vs. single-bottle PL' },
 { code:'K-06', name:'Subscription / Lock-in Models', direction: 'Expansion', rationale:'Booster + diffuser refill subscription economics' },
 ],
 sources: [
'NPD Group Fragrance Consumer Report 2025',
'Givaudan / Firmenich Laundry Scent Premiumisation White Papers',
'Mintel Fabric Conditioner Market 2025',
'Sephora @ Kohl\'s Laundry-Scent Crossover Pilot Case Study',
'PRISM Trend Database: C-09, C-17, T-15, G-08',
 ],
 consumerJourneyStages: ['3 — Prepare','4 — Add Products','7 — Maintain & Optimize'],
 imageGradient:'linear-gradient(135deg, #9333ea 0%, #4c1d95 100%)',
 imageAccent:'#a855f7',
 },
];
