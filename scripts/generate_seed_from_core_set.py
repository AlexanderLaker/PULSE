...
Inputs (both in the repository so the base is reproducible):
  data/trend_base_2026-09/core_set_51_v4.json   the 51 reviewed drivers
...
CORE_SET = ROOT / "data" / "trend_base_2026-09" / "core_set_51_v4.json"
...
def render_seed(recs: list[dict], verdicts: dict) -> str:
    ...
    a("data/trend_base_2026-09/core_set_51_v4.json (the reviewed core set of the")
